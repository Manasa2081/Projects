...
from tensorflow.keras.utils import to_categorical  # type: ignore # ✅ Correct import
...
def graph():
    df=pd.DataFrame([['NaiveBayes','Precision',precision[0]],['Naive Bayes','Recall',recall[0]],['NaiveBayes','F1Score',fscore[0]],['Naive Bayes','Accuracy',accuracy[0]],
['DecisionTree','Precision',precision[1]],['Decision Tree','Recall',recall[1]],['DecisionTree','F1Score',fscore[1]],['Decision Tree','Accuracy',accuracy[1]],
['RandomForest','Precision',precision[2]],['Random Forest','Recall',recall[2]],['RandomForest','F1Score',fscore[2]],['Random Forest','Accuracy',accuracy[2]],
['LogisticRegression','Precision',precision[3]],['LogisticRegression','Recall',recall[3]],['LogisticRegression','F1Score',fscore[3]],['LogisticRegression','Accuracy',accuracy[3]],
['BaggingClassifier','Precision',precision[4]],['BaggingClassifier','Recall',recall[4]],['BaggingClassifier','F1Score',fscore[4]],['Bagging Classifier','Accuracy',accuracy[4]],
['GradientBoosting','Precision',precision[5]],['GradientBoosting','Recall',recall[5]],['GradientBoosting','F1Score',fscore[5]],['GradientBoosting','Accuracy',accuracy[5]],
